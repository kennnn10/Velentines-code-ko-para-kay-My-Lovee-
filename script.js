...
function yes() {
    ...
    question.textContent = "Yey! pumayag na sya mwehwehw"
    gif.src = 'happy cat.gif'
    createHearts(100);
}
var phrase = ['bakit po ayaw mo?', 'ayaw mopo ako kadate?:(', 'ayaw parin talaga po?', 'payag kana po ohh', 'pag pinidot moto payag kana po mwehehewe thru video po pag ayaw mopo talaga 😔 ;)']
var gifs = ['cat sad.gif', 'ken sad.gif', 'patrick sad.gif', 'Pokemon sad.gif', 'stitch sad.gif', '/assets/ me sad.gif']
var noCount = 0
function no() {
    if (noCount != 5) {
